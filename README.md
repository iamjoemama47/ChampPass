...
### doel
    Een makkelijke overszichtelijke website maken zodat mensen snel en eenvoudig aan tickets kunnen geraken.
### betrokken partijen
    Alle ploegen die meedoen met het tornooi en de fans die een ticket kopen.
### product owner en Stakeholders
    UEFA is onze product owner aangezien we nauw samenwerken met hun voor de organisatie van de ticket verkoop.
## 2. Projectdoel en-scope
### Hoofddoel
    Ons hoofddoel is om de ticketverkoop helemaal te laten werken met een simulatie van een verkoop Ook korte infomatie zoals het stadion en tijdstippen zijn belangrijk.
...
### Wettelijke eisen
    Er mogen geen kosten achterwege gehouden worden om die dan later aan te rekenen, alle kosten moeten duidelijk zijn op het moment van de bestelling. De algemene voorwaarden over de eventuele retournering moet duidelijk aangegeven zijn. Er moet privacy van de gegevens van de klanten zijn zodat er geen persoonlijke dingen gelekt worden.
